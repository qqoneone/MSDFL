...
def main(dataset, algorithm,batch_size, learning_rate, lamda, num_glob_iters,
         local_epochs, optimizer, numusers, K, times, gpu,n_attackers,attacker_type,lambda_JR,num_GoodUsers,iid,resume,mode):
    ...
    for i in range(times):
        ...
        if(algorithm == "FLTrust"):
            server = FLTrust(device, dataset, algorithm, model, batch_size, learning_rate,num_glob_iters, local_epochs, optimizer, numusers, i,n_attackers,attacker_type,lambda_JR,num_GoodUsers,iid,resume,mode)
        server.train()
        server.test()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, default="risk", choices=["risk", "logits"])
