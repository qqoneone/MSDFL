...
def main(dataset, algorithm,batch_size, learning_rate, lamda, num_glob_iters,
    ...
    for i in range(times):
        ...
        if(algorithm == "FedAvg"):
            server = FedAvg(device, dataset, algorithm, model, batch_size, learning_rate,num_glob_iters, local_epochs, optimizer, numusers, i,n_attackers,attacker_type,lambda_JR,num_GoodUsers,iid,mode)
        server.train()
        server.test()
